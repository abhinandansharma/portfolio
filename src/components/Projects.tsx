    ...
    <section id="projects" className="section" style={{ borderTop: '1px solid var(--line)' }}>
      <div className="wrap">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {projects.map((p, i) => (
            <article key={p.title} className="card card-click reveal flex flex-col" style={{ ['--i' as string]: i % 3 }} role="button" tabIndex={0} aria-label={`${p.title}, details`} onClick={openCard(i)} onKeyDown={openCard(i)}>
